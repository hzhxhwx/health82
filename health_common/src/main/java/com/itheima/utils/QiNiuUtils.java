...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "mjKG2F2SMyZG8ot-TBPvkWrhT3kLzsY00BIV1K9E";
    private static final String SECRETKEY = "omdlCDF1XsDlL647Mj5r-bBJL8cuRZzl8qvTpY1B";
    private static final String BUCKET = "image-server0127";
    public static final String DOMAIN= "http://q2npjxs32.bkt.clouddn.com/";
